...
#include "..\Library\DiffuseLightingMaterial.h"
...
namespace Rendering
{
	...
	DiffuseLightingDemo::DiffuseLightingDemo(Game& game, Camera& camera)
		...
		mRenderStateHelper(nullptr), mSpriteBatch(nullptr), mSpriteFont(nullptr), mTextPosition(0.0f, 0.5f)
	{
	}
	...
	void DiffuseLightingDemo::Initialize()
	{
		...
		mProxyModel = new ProxyModel(*mGame, *mCamera, "..\\source\\Library\\Content\\Models\\DirectionalLightProxy.obj", 0.5f);
