...
#include "..\Library\DistortionMappingPostMaterial.h"
...
namespace Rendering
{
	...
	void DistortionMappingPostGame::Initialize()
	{
		...
		mSpriteFont = new SpriteFont(mDirect3DDevice, L"..\\source\\Library\\Content\\Arial_14_Regular.spritefont");

		std::wstring textureName = L"..\\source\\Library\\Content\\Textures\\DistortionGlass.png";
