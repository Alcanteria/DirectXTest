...
namespace Library
{
	...
	Mouse::Mouse(Game& game, LPDIRECTINPUT8 directInput) : GameComponent(game), mDirectInput(directInput), mDevice(nullptr), mX(0), mY(0), mWheel(0)
	{
	...
	void Mouse::Initialize()
	{
		...
		{
			throw GameException("IDRECTINPUT8::CreateDevice() failed.");
		}
		...
		{
			throw GameException("IDIRECTINPUTDEVICE8::SetCooperationLevel() failed.");
		}
	...
	bool Mouse::WasButtonReleaseThisFrame(MouseButtons button) const
	{
